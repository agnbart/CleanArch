...
export interface IContractItemClient {
    get(): Observable<ContractsVm>;
    post(command: CreateContractCommand): Observable<number>;
}

@Injectable({
    providedIn: 'root'
})
export class ContractItemClient implements IContractItemClient {
    ...
    get(): Observable<ContractsVm> {
        let url_ = this.baseUrl + "/api/ContractItem";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ContractsVm>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ContractsVm>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<ContractsVm> {
        ...
        if (status === 200) {
            ...
            result200 = ContractsVm.fromJS(resultData200);
...
export interface IContractorItemClient {
    post(command: CreateContractorCommand): Observable<number>;
}

@Injectable({
    providedIn: 'root'
})
export class ContractorItemClient implements IContractorItemClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    post(command: CreateContractorCommand): Observable<number> {
        let url_ = this.baseUrl + "/api/ContractorItem";
        url_ = url_.replace(/[?&]$/, "");
...
export class ContractsVm implements IContractsVm {
    ...
    static fromJS(data: any): ContractsVm {
        data = typeof data === 'object' ? data : {};
        let result = new ContractsVm();
        result.init(data);
        return result;
    }
...
export class CreateContractCommand implements ICreateContractCommand {
    contractId?: string;
    contractor1?: string;
    contractor1Description?: string | undefined;
    contractor2?: string;
    contractor2Description?: string | undefined;
    contractDate?: Date;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.contractor1Description = _data["contractor1Description"];
            this.contractor2 = _data["contractor2"];
            this.contractor2Description = _data["contractor2Description"];
            this.contractDate = _data["contractDate"] ? new Date(_data["contractDate"].toString()) : <any>undefined;
            this.contractDescription = _data["contractDescription"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["contractor1Description"] = this.contractor1Description;
        data["contractor2"] = this.contractor2;
        data["contractor2Description"] = this.contractor2Description;
...
export class CreateContractorCommand implements ICreateContractorCommand {
    contractorId?: string;
    ...
    constructor(data?: ICreateContractorCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateContractorCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateContractorCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateContractorCommand {
    contractorId?: string;
    name1?: string | undefined;
    name2?: string | undefined;
    city?: string | undefined;
